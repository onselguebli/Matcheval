...
@Component({
  selector: 'app-widgets-dropdown-new',
  templateUrl: './widgets-dropdown.componentNew.html',
  styleUrls: ['./widgets-dropdown.componentNew.scss'],
...
export class WidgetsDropdownComponentNew implements OnInit, AfterContentInit {
